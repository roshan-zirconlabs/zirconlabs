    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-purple-100 pb-5">
        ...
        <div className="flex items-center gap-2">
          <Link href={`/bots/${botId}/edit`} className="inline-flex items-center gap-1 rounded-lg border border-slate-200 px-2.5 py-1.5 text-xs text-slate-600 hover:bg-slate-50">
            <SlidersHorizontal className="h-3.5 w-3.5" /> Advanced canvas
          </Link>
          <ActivationControl
            botId={botId}
            status={bot.status}
